...
const CompressImage = () => {
  ...
  return (
    <div style={{ backgroundColor: '#f4f4f4', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', maxWidth: '800px', margin: '0 auto', marginTop: '50px' }}>
      ...
      {selectedFile && (
        <>
          <div style={{ marginBottom: '10px', textAlign: 'center' }}>
            ...
            <p>
              Ukuran pixel: {imageWidth} x {imageHeight}
            </p>
          </div>
          ...
          <div style={{ marginBottom: '20px', textAlign: 'center' }}>
            ...
            <select id="format" value={compressionFormat} onChange={(e) => setCompressionFormat(e.target.value)} style={{ padding: '5px', borderRadius: '3px', border: '1px solid #ccc', backgroundColor: '#f9f9f9' }}>
